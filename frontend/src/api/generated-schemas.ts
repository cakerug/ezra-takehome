...
* Do not edit by hand -- changes will be overwritten. Run `npm run gen:api` after changing `backend/TodoApi/Dtos/*.cs`.
*
* We could have written these types by hand instead of generating them which I would say is fine for
* an application with a single developer, but the task instructions call out "communication between frontend and
backend"
